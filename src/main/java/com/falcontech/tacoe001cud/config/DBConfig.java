package com.falcontech.tacoe001cud.config;
...
@Slf4j
@Configuration
@EntityScan("com.falcontech.tacoe001cud.model")
@EnableJpaRepositories(basePackages = "com.falcontech.tacoe001cud.repo")
public class DBConfig {
  ...
  public DataSource mysqlDataSourceDev() {
    ...
    dataSource.setUrl("jdbc:mysql://192.168.110.128:3306/DB1");
    dataSource.setUsername("source_db1");
